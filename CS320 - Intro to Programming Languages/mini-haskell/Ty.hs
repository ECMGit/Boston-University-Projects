...
ty gamma fvs (If e1 e2 e3) =
  Error "Assignment 7, Problem 3, Part B: not yet implemented."

-- Assignment 7, Problem 3, Part C

ty gamma fvs (Tuple es) =
  Error "Assignment 7, Problem 3, Part C: not yet implemented."

-- Assignment 7, Problem 3, Part D

ty gamma (fv:fvs') (Lam [x] e) =
  Error "Assignment 7, Problem 3, Part D: not yet implemented."
